...
pt1sim_hist_Save = pt1sim_hist.Clone()
...
pt1rawsim_hist_Save = pt1rawsim_hist.Clone()
...
pt1nomsim_hist_Save = pt1nomsim_hist.Clone()
...
pt2sim_hist_Save = pt2sim_hist.Clone()
...
pt2rawsim_hist_Save = pt2rawsim_hist.Clone()
...
pt2nomsim_hist_Save = pt2nomsim_hist.Clone()
...
pt3sim_hist_Save = pt3sim_hist.Clone()
...
pt3rawsim_hist_Save = pt3rawsim_hist.Clone()
...
pt3nomsim_hist_Save = pt3nomsim_hist.Clone()
...
mjjsim_hist_Save = mjjsim_hist.Clone()
...
mjjrawsim_hist_Save = mjjrawsim_hist.Clone()
...
mjjnomsim_hist_Save = mjjnomsim_hist.Clone()
...
pt1sim_hist_Save.Write()
pt1rawsim_hist_Save.Write()
pt1nomsim_hist_Save.Write()
pt2sim_hist_Save.Write()
pt2rawsim_hist_Save.Write()
pt2nomsim_hist_Save.Write()
pt3sim_hist_Save.Write()
pt3rawsim_hist_Save.Write()
pt3nomsim_hist_Save.Write()
mjjsim_hist_Save.Write()
mjjrawsim_hist_Save.Write()
mjjnomsim_hist_Save.Write()
outHistFile.Close()
