...
RootHisttoPdf(outDirectory+"PlottriggerEfficiency_withFit_HLT_PFJet550.pdf",HLT_PFJet550,Ref_HLT_PFJet500,"Trigger_{Eff}","M_{jj} [GeV]","Run3 C Trigger Efficiency pt>550")
