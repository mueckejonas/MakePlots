...
RootHisttoPdf(outDirectory+"Plot_DijetAsymmetry_Run2023C.pdf",PtAsym,"Events","(P_{t1}-P_{t2})/(P_{t1}+P_{t2})","Dijet Asymmetry Run3 C 2023")

#Plot phidiff
PhiDiff =RootFile.Get("PhiDifference")
RootHisttoPdf(outDirectory+"Plot_PhiDifference_Run2023C.pdf",PhiDiff,"Events","Degree","#phi Difference for Run3 C 2023")

#Plot thetadiff
ThetaDiff =RootFile.Get("ThetaDifference")
RootHisttoPdf(outDirectory+"Plot_ThetaDifference_Run2023C.pdf",ThetaDiff,"Events","Degree","#theta Difference for Run3 C 2023")

#Plot YDifference
YDiff =RootFile.Get("YDifference")
RootHisttoPdf(outDirectory+"Plot_YDifference_Run2023C.pdf",YDiff,"Events","Y_{1}-Y_{2}","Y Difference for Run3 C 2023")

#Plot EtaDifference
EtaDiff =RootFile.Get("EtaDifference")
RootHisttoPdf(outDirectory+"Plot_EtaDifference_Run2023C.pdf",EtaDiff,"Events","#eta_{1}-#eta_{2}","Eta Difference for Run3 C 2023")
