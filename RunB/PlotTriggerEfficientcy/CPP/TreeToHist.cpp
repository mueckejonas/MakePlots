int TreeToHist()
{
  ...
  TH1D Ref_HLT_PFJet40("Ref_HLT_PFJet40","Ref_HLT_PFJet40",100,0,2000);
  Ref_HLT_PFJet40.Sumw2();
  TH1D Ref_HLT_PFJet60("Ref_HLT_PFJet60","Ref_HLT_PFJet60",100,0,2000);
  Ref_HLT_PFJet60.Sumw2();
  TH1D Ref_HLT_PFJet80("Ref_HLT_PFJet80","Ref_HLT_PFJet80",100,0,2000);
  Ref_HLT_PFJet80.Sumw2();
  TH1D Ref_HLT_PFJet110("Ref_HLT_PFJet110","Ref_HLT_PFJet110",100,0,2000);
  Ref_HLT_PFJet110.Sumw2();
  TH1D Ref_HLT_PFJet140("Ref_HLT_PFJet140","Ref_HLT_PFJet140",100,0,2000);
  Ref_HLT_PFJet140.Sumw2();
  TH1D Ref_HLT_PFJet200("Ref_HLT_PFJet200","Ref_HLT_PFJet200",100,0,2000);
  Ref_HLT_PFJet200.Sumw2();
  TH1D Ref_HLT_PFJet260("Ref_HLT_PFJet260","Ref_HLT_PFJet260",100,0,2000);
  Ref_HLT_PFJet260.Sumw2();
  TH1D Ref_HLT_PFJet320("Ref_HLT_PFJet320","Ref_HLT_PFJet320",100,0,2000);
  Ref_HLT_PFJet320.Sumw2();
  TH1D Ref_HLT_PFJet400("Ref_HLT_PFJet400","Ref_HLT_PFJet400",100,0,2000);
  Ref_HLT_PFJet400.Sumw2();
  TH1D Ref_HLT_PFJet450("Ref_HLT_PFJet450","Ref_HLT_PFJet450",100,0,2000);
  Ref_HLT_PFJet450.Sumw2();
  TH1D Ref_HLT_PFJet500("Ref_HLT_PFJet500","Ref_HLT_PFJet500",100,0,2000);
  Ref_HLT_PFJet500.Sumw2();
  TH1D Ref_HLT_PFJet550("Ref_HLT_PFJet550","Ref_HLT_PFJet550",100,0,2000);
  Ref_HLT_PFJet550.Sumw2();
  gStyle->SetErrorX(0.);

  TH1D HLT_PFJet40("HLT_PFJet40","HLT_PFJet40",100,0,2000);
  HLT_PFJet40.Sumw2();
  TH1D HLT_PFJet60("HLT_PFJet60","HLT_PFJet60",100,0,2000);
  HLT_PFJet60.Sumw2();
  TH1D HLT_PFJet80("HLT_PFJet80","HLT_PFJet80",100,0,2000);
  HLT_PFJet80.Sumw2();
  TH1D HLT_PFJet110("HLT_PFJet110","HLT_PFJet110",100,0,2000);
  HLT_PFJet110.Sumw2();
  TH1D HLT_PFJet140("HLT_PFJet140","HLT_PFJet140",100,0,2000);
  HLT_PFJet140.Sumw2();
  TH1D HLT_PFJet200("HLT_PFJet200","HLT_PFJet200",100,0,2000);
  HLT_PFJet200.Sumw2();
  TH1D HLT_PFJet260("HLT_PFJet260","HLT_PFJet260",100,0,2000);
  HLT_PFJet260.Sumw2();
  TH1D HLT_PFJet320("HLT_PFJet320","HLT_PFJet320",100,0,2000);
  HLT_PFJet320.Sumw2();
  TH1D HLT_PFJet400("HLT_PFJet400","HLT_PFJet400",100,0,2000);
  HLT_PFJet400.Sumw2();
  TH1D HLT_PFJet450("HLT_PFJet450","HLT_PFJet450",100,0,2000);
  HLT_PFJet450.Sumw2();
  TH1D HLT_PFJet500("HLT_PFJet500","HLT_PFJet500",100,0,2000);
  HLT_PFJet500.Sumw2();
  TH1D HLT_PFJet550("HLT_PFJet550","HLT_PFJet550",100,0,2000);
  HLT_PFJet550.Sumw2();
  ...
  TH1D Ref_HLT_PFHT180("Ref_HLT_PFHT180","Ref_HLT_PFHT180",100,0,2000);
  Ref_HLT_PFHT180.Sumw2();
  TH1D Ref_HLT_PFHT250("Ref_HLT_PFHT250","Ref_HLT_PFHT250",100,0,2000);
  Ref_HLT_PFHT250.Sumw2();
  TH1D Ref_HLT_PFHT350("Ref_HLT_PFHT350","Ref_HLT_PFHT350",100,0,2000);
  Ref_HLT_PFHT350.Sumw2();
  TH1D Ref_HLT_PFHT370("Ref_HLT_PFHT370","Ref_HLT_PFHT370",100,0,2000);
  Ref_HLT_PFHT370.Sumw2();
  TH1D Ref_HLT_PFHT430("Ref_HLT_PFHT430","Ref_HLT_PFHT430",100,0,2000);
  Ref_HLT_PFHT430.Sumw2();
  TH1D Ref_HLT_PFHT510("Ref_HLT_PFHT510","Ref_HLT_PFHT510",100,0,2000);
  Ref_HLT_PFHT510.Sumw2();
  TH1D Ref_HLT_PFHT590("Ref_HLT_PFHT590","Ref_HLT_PFHT590",100,0,2000);
  Ref_HLT_PFHT590.Sumw2();
  TH1D Ref_HLT_PFHT680("Ref_HLT_PFHT680","Ref_HLT_PFHT680",100,0,2000);
  Ref_HLT_PFHT680.Sumw2();
  TH1D Ref_HLT_PFHT780("Ref_HLT_PFHT780","Ref_HLT_PFHT780",100,0,2000);
  Ref_HLT_PFHT780.Sumw2();
  TH1D Ref_HLT_PFHT890("Ref_HLT_PFHT890","Ref_HLT_PFHT890",100,0,2000);
  Ref_HLT_PFHT890.Sumw2();
  TH1D Ref_HLT_PFHT1050("Ref_HLT_PFHT1050","Ref_HLT_PFHT1050",100,0,2000);
  Ref_HLT_PFHT1050.Sumw2();

  TH1D HLT_PFHT180("HLT_PFHT180","HLT_PFHT180",100,0,2000);
  HLT_PFHT180.Sumw2();
  TH1D HLT_PFHT250("HLT_PFHT250","HLT_PFHT250",100,0,2000);
  HLT_PFHT250.Sumw2();
  TH1D HLT_PFHT350("HLT_PFHT350","HLT_PFHT350",100,0,2000);
  HLT_PFHT350.Sumw2();
  TH1D HLT_PFHT370("HLT_PFHT370","HLT_PFHT370",100,0,2000);
  HLT_PFHT370.Sumw2();
  TH1D HLT_PFHT430("HLT_PFHT430","HLT_PFHT430",100,0,2000);
  HLT_PFHT430.Sumw2();
  TH1D HLT_PFHT510("HLT_PFHT510","HLT_PFHT510",100,0,2000);
  HLT_PFHT510.Sumw2();
  TH1D HLT_PFHT590("HLT_PFHT590","HLT_PFHT590",100,0,2000);
  HLT_PFHT590.Sumw2();
  TH1D HLT_PFHT680("HLT_PFHT680","HLT_PFHT680",100,0,2000);
  HLT_PFHT680.Sumw2();
  TH1D HLT_PFHT780("HLT_PFHT780","HLT_PFHT780",100,0,2000);
  HLT_PFHT780.Sumw2();
  TH1D HLT_PFHT890("HLT_PFHT890","HLT_PFHT890",100,0,2000);
  HLT_PFHT890.Sumw2();
  TH1D HLT_PFHT1050("HLT_PFHT1050","HLT_PFHT1050",100,0,2000);
  HLT_PFHT1050.Sumw2();
