int RootToHistSim()
{
  ...
  for (int i = 0; i < 13; i++)
  {
    ...
    string outName1 = "/nfs/dust/cms/user/mueckejo/RootTempStorage/"+ranges[i]+"_PlotSimulation_Run32023_MC.root";
    string outName2 = "/nfs/dust/cms/user/mueckejo/RootTempStorage/"+ranges[i]+"_PlotSimulation_Run32023_Gen.root";
