...
JetResolution300to470, JetResolutionErr300to470, MeanResolution300to470, MeanResolutionErr300to470 = CalcResolution(Response300to470,outDirectory+"Response_Jet3_300to470_Run2023.pdf","Events","Response","Response for pt3 300to470",100000,0,0.05)
JetResolution470to600, JetResolutionErr470to600, MeanResolution470to600, MeanResolutionErr470to600 = CalcResolution(Response470to600,outDirectory+"Response_Jet3_470to600_Run2023.pdf","Events","Response","Response for pt3 470to600",100000,0,0.05)
JetResolution600to800, JetResolutionErr600to800, MeanResolution600to800, MeanResolutionErr600to800 = CalcResolution(Response600to800,outDirectory+"Response_Jet3_600to800_Run2023.pdf","Events","Response","Response for pt3 600to800",100000,0,0.05)
JetResolution800to1000, JetResolutionErr800to1000, MeanResolution800to1000, MeanResolutionErr800to1000 = CalcResolution(Response800to1000,outDirectory+"Response_Jet3_800to1000_Run2023.pdf","Events","Response","Response for pt3 800to1000",1600000,0,0.06)
JetResolution1000to1400, JetResolutionErr1000to1400, MeanResolution1000to1400, MeanResolutionErr1000to1400 = CalcResolution(Response1000to1400,outDirectory+"Response_Jet3_1000to1400_Run2023.pdf","Events","Response","Response for pt3 1000to1400",100000,0,0.05)
JetResolution1400to1800, JetResolutionErr1400to1800, MeanResolution1400to1800, MeanResolutionErr1400to1800 = CalcResolution(Response1400to1800,outDirectory+"Response_Jet3_1400to1800_Run2023.pdf","Events","Response","Response for pt3 1400to1800",2500000,0,0.1)
JetResolution1800to2400, JetResolutionErr1800to2400, MeanResolution1800to2400, MeanResolutionErr1800to2400 = CalcResolution(Response1800to2400,outDirectory+"Response_Jet3_1800to2400_Run2023.pdf","Events","Response","Response for pt3 1800to2400",1400000,0,0.05)
JetResolution2400to3200, JetResolutionErr2400to3200, MeanResolution2400to3200, MeanResolutionErr2400to3200 = CalcResolution(Response2400to3200,outDirectory+"Response_Jet3_2400to3200_Run2023.pdf","Events","Response","Response for pt3 2400to3200",100000,0,0.05)
JetResolution3200, JetResolutionErr3200, MeanResolution3200, MeanResolutionErr3200 = CalcResolution(Response3200,outDirectory+"Response_Jet3_3200_Run2023.pdf","Events","Response","Response for pt3 3200",10000,0,0.05)
...
canvas.Print(outDirectory+"MeanResolutionfromPt3_Run2023Sim.pdf")

#create and save root file with all added hists
outHistFile = ROOT.TFile.Open("/home/jmuecke/code/mueckejonas/BachelorArbeitJM/BachelorStorage/Sim/RootS/FitJetResolutionJet3.root","RECREATE")
