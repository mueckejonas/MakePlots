...
JetResolution50to80, JetResolutionErr50to80 = CalcResolution(Response50to80,outDirectory+"Response_Jet2_50to80_Run2023.pdf","Events","Response","Response for pt2 50to80",1000,0,0.05)
JetResolution80to120, JetResolutionErr80to120 = CalcResolution(Response80to120,outDirectory+"Response_Jet2_80to120_Run2023.pdf","Events","Response","Response for pt2 80to120",10000,0,0.05)
JetResolution120to170, JetResolutionErr120to170 = CalcResolution(Response120to170,outDirectory+"Response_Jet2_120to170_Run2023.pdf","Events","Response","Response for pt2 120to170",100000,0,0.05)
JetResolution170to300, JetResolutionErr170to300 = CalcResolution(Response170to300,outDirectory+"Response_Jet2_170to300_Run2023.pdf","Events","Response","Response for pt2 170to300",100000,0,0.05)
JetResolution300to470, JetResolutionErr300to470 = CalcResolution(Response300to470,outDirectory+"Response_Jet2_300to470_Run2023.pdf","Events","Response","Response for pt2 300to470",100000,0,0.05)
JetResolution470to600, JetResolutionErr470to600 = CalcResolution(Response470to600,outDirectory+"Response_Jet2_470to600_Run2023.pdf","Events","Response","Response for pt2 470to600",1400000,0,0.5)
JetResolution600to800, JetResolutionErr600to800 = CalcResolution(Response600to800,outDirectory+"Response_Jet2_600to800_Run2023.pdf","Events","Response","Response for pt2 600to800",100000,0,0.05)
JetResolution800to1000, JetResolutionErr800to1000 = CalcResolution(Response800to1000,outDirectory+"Response_Jet2_800to1000_Run2023.pdf","Events","Response","Response for pt2 800to1000",100000,0,0.05)
JetResolution1000to1400, JetResolutionErr1000to1400 = CalcResolution(Response1000to1400,outDirectory+"Response_Jet2_1000to1400_Run2023.pdf","Events","Response","Response for pt2 1000to1400",100000,0,0.05)
JetResolution1400to1800, JetResolutionErr1400to1800 = CalcResolution(Response1400to1800,outDirectory+"Response_Jet2_1400to1800_Run2023.pdf","Events","Response","Response for pt2 1400to1800",2500000,0,0.1)
JetResolution1800to2400, JetResolutionErr1800to2400 = CalcResolution(Response1800to2400,outDirectory+"Response_Jet2_1800to2400_Run2023.pdf","Events","Response","Response for pt2 1800to2400",100000,0,0.05)
JetResolution2400to3200, JetResolutionErr2400to3200 = CalcResolution(Response2400to3200,outDirectory+"Response_Jet2_2400to3200_Run2023.pdf","Events","Response","Response for pt2 2400to3200",100000,0,0.05)
JetResolution3200, JetResolutionErr3200 = CalcResolution(Response3200,outDirectory+"Response_Jet2_3200_Run2023.pdf","Events","Response","Response for pt2 3200",10000,0,0.05)
...
with open('/home/jmuecke/code/mueckejonas/BachelorArbeitJM/BachelorStorage/Sim/CSV/JetResolutionPt2.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
