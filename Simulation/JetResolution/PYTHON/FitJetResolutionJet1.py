...
JetResolution50to80, JetResolutionErr50to80 = CalcResolution(Response50to80,outDirectory+"Response_Jet1_50to80_Run2023.pdf","Events","Response","Response for pt1 50to80",10000,0,0.05)
JetResolution80to120, JetResolutionErr80to120 = CalcResolution(Response80to120,outDirectory+"Response_Jet1_80to120_Run2023.pdf","Events","Response","Response for pt1 80to120",10000,0,0.05)
JetResolution120to170, JetResolutionErr120to170 = CalcResolution(Response120to170,outDirectory+"Response_Jet1_120to170_Run2023.pdf","Events","Response","Response for pt1 120to170",10000,0,0.05)
JetResolution170to300, JetResolutionErr170to300 = CalcResolution(Response170to300,outDirectory+"Response_Jet1_170to300_Run2023.pdf","Events","Response","Response for pt1 170to300",10000,0,0.05)
JetResolution300to470, JetResolutionErr300to470 = CalcResolution(Response300to470,outDirectory+"Response_Jet1_300to470_Run2023.pdf","Events","Response","Response for pt1 300to470",10000,0,0.05)
JetResolution470to600, JetResolutionErr470to600 = CalcResolution(Response470to600,outDirectory+"Response_Jet1_470to600_Run2023.pdf","Events","Response","Response for pt1 470to600",10000,0,0.05)
JetResolution600to800, JetResolutionErr600to800 = CalcResolution(Response600to800,outDirectory+"Response_Jet1_600to800_Run2023.pdf","Events","Response","Response for pt1 600to800",10000,0,0.05)
JetResolution800to1000, JetResolutionErr800to1000 = CalcResolution(Response800to1000,outDirectory+"Response_Jet1_800to1000_Run2023.pdf","Events","Response","Response for pt1 800to1000",10000,0,0.05)
JetResolution1000to1400, JetResolutionErr1000to1400 = CalcResolution(Response1000to1400,outDirectory+"Response_Jet1_1000to1400_Run2023.pdf","Events","Response","Response for pt1 1000to1400",10000,0,0.05)
...
JetResolution1800to2400, JetResolutionErr1800to2400 = CalcResolution(Response1800to2400,outDirectory+"Response_Jet1_1800to2400_Run2023.pdf","Events","Response","Response for pt1 1800to2400",10000,0,0.05)
JetResolution2400to3200, JetResolutionErr2400to3200 = CalcResolution(Response2400to3200,outDirectory+"Response_Jet1_2400to3200_Run2023.pdf","Events","Response","Response for pt1 2400to3200",10000,0,0.05)
