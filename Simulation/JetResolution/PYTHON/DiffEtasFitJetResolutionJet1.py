...
Eta0to1p3JetResolution50to80, Eta0to1p3JetResolutionErr50to80 = CalcResolution(Eta0to1p3Response50to80,outDirectory+"Eta0to1p3_Response_Jet1_50to80_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 50to80",10000,0,0.05)
Eta0to1p3JetResolution80to120, Eta0to1p3JetResolutionErr80to120 = CalcResolution(Eta0to1p3Response80to120,outDirectory+"Eta0to1p3_Response_Jet1_80to120_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 80to120",10000,0,0.05)
Eta0to1p3JetResolution120to170, Eta0to1p3JetResolutionErr120to170 = CalcResolution(Eta0to1p3Response120to170,outDirectory+"Eta0to1p3_Response_Jet1_120to170_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 120to170",10000,0,0.05)
Eta0to1p3JetResolution170to300, Eta0to1p3JetResolutionErr170to300 = CalcResolution(Eta0to1p3Response170to300,outDirectory+"Eta0to1p3_Response_Jet1_170to300_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 170to300",10000,0,0.05)
Eta0to1p3JetResolution300to470, Eta0to1p3JetResolutionErr300to470 = CalcResolution(Eta0to1p3Response300to470,outDirectory+"Eta0to1p3_Response_Jet1_300to470_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 300to470",10000,0,0.05)
Eta0to1p3JetResolution470to600, Eta0to1p3JetResolutionErr470to600 = CalcResolution(Eta0to1p3Response470to600,outDirectory+"Eta0to1p3_Response_Jet1_470to600_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 470to600",10000,0,0.05)
Eta0to1p3JetResolution600to800, Eta0to1p3JetResolutionErr600to800 = CalcResolution(Eta0to1p3Response600to800,outDirectory+"Eta0to1p3_Response_Jet1_600to800_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 600to800",10000,0,0.05)
Eta0to1p3JetResolution800to1000, Eta0to1p3JetResolutionErr800to1000 = CalcResolution(Eta0to1p3Response800to1000,outDirectory+"Eta0to1p3_Response_Jet1_800to1000_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 800to1000",10000,0,0.05)
Eta0to1p3JetResolution1000to1400, Eta0to1p3JetResolutionErr1000to1400 = CalcResolution(Eta0to1p3Response1000to1400,outDirectory+"Eta0to1p3_Response_Jet1_1000to1400_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 1000to1400",10000,0,0.05)
Eta0to1p3JetResolution1400to1800, Eta0to1p3JetResolutionErr1400to1800 = CalcResolution(Eta0to1p3Response1400to1800,outDirectory+"Eta0to1p3_Response_Jet1_1400to1800_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 1400to1800",2500000,0,0.1)
Eta0to1p3JetResolution1800to2400, Eta0to1p3JetResolutionErr1800to2400 = CalcResolution(Eta0to1p3Response1800to2400,outDirectory+"Eta0to1p3_Response_Jet1_1800to2400_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 1800to2400",140000,0,0.08)
Eta0to1p3JetResolution2400to3200, Eta0to1p3JetResolutionErr2400to3200 = CalcResolution(Eta0to1p3Response2400to3200,outDirectory+"Eta0to1p3_Response_Jet1_2400to3200_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 2400to3200",10000,0,0.05)
Eta0to1p3JetResolution3200, Eta0to1p3JetResolutionErr3200 = CalcResolution(Eta0to1p3Response3200,outDirectory+"Eta0to1p3_Response_Jet1_3200_Run2023.pdf","Events","Eta 0 to 1.3 Response","Eta 0 to 1.3 Response for pt1 3200",10000,0,0.05)
...
Eta1p3to2p5JetResolution50to80, Eta1p3to2p5JetResolutionErr50to80 = CalcResolution(Eta1p3to2p5Response50to80,outDirectory+"Eta1p3to2p5_Response_Jet1_50to80_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 50to80",10000,0,0.05)
Eta1p3to2p5JetResolution80to120, Eta1p3to2p5JetResolutionErr80to120 = CalcResolution(Eta1p3to2p5Response80to120,outDirectory+"Eta1p3to2p5_Response_Jet1_80to120_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 80to120",10000,0,0.05)
Eta1p3to2p5JetResolution120to170, Eta1p3to2p5JetResolutionErr120to170 = CalcResolution(Eta1p3to2p5Response120to170,outDirectory+"Eta1p3to2p5_Response_Jet1_120to170_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 120to170",10000,0,0.05)
Eta1p3to2p5JetResolution170to300, Eta1p3to2p5JetResolutionErr170to300 = CalcResolution(Eta1p3to2p5Response170to300,outDirectory+"Eta1p3to2p5_Response_Jet1_170to300_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 170to300",10000,0,0.05)
Eta1p3to2p5JetResolution300to470, Eta1p3to2p5JetResolutionErr300to470 = CalcResolution(Eta1p3to2p5Response300to470,outDirectory+"Eta1p3to2p5_Response_Jet1_300to470_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 300to470",10000,0,0.05)
Eta1p3to2p5JetResolution470to600, Eta1p3to2p5JetResolutionErr470to600 = CalcResolution(Eta1p3to2p5Response470to600,outDirectory+"Eta1p3to2p5_Response_Jet1_470to600_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 470to600",10000,0,0.05)
Eta1p3to2p5JetResolution600to800, Eta1p3to2p5JetResolutionErr600to800 = CalcResolution(Eta1p3to2p5Response600to800,outDirectory+"Eta1p3to2p5_Response_Jet1_600to800_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 600to800",10000,0,0.05)
Eta1p3to2p5JetResolution800to1000, Eta1p3to2p5JetResolutionErr800to1000 = CalcResolution(Eta1p3to2p5Response800to1000,outDirectory+"Eta1p3to2p5_Response_Jet1_800to1000_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 800to1000",10000,0,0.05)
Eta1p3to2p5JetResolution1000to1400, Eta1p3to2p5JetResolutionErr1000to1400 = CalcResolution(Eta1p3to2p5Response1000to1400,outDirectory+"Eta1p3to2p5_Response_Jet1_1000to1400_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 1000to1400",10000,0,0.05)
Eta1p3to2p5JetResolution1400to1800, Eta1p3to2p5JetResolutionErr1400to1800 = CalcResolution(Eta1p3to2p5Response1400to1800,outDirectory+"Eta1p3to2p5_Response_Jet1_1400to1800_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 1400to1800",2500000,0,0.1)
Eta1p3to2p5JetResolution1800to2400, Eta1p3to2p5JetResolutionErr1800to2400 = CalcResolution(Eta1p3to2p5Response1800to2400,outDirectory+"Eta1p3to2p5_Response_Jet1_1800to2400_Run2023.pdf","Events","Eta 1.3 to 2.5 Response","Eta 1.3 to 2.5 Response for pt1 1800to2400",140000,0,0.08)
...
with open('/home/jmuecke/code/mueckejonas/BachelorArbeitJM/BachelorStorage/Sim/CSV/Eta1p3to2p5JetResolutionPt1.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
Eta2p5to3JetResolution50to80, Eta2p5to3JetResolutionErr50to80 = CalcResolution(Eta2p5to3Response50to80,outDirectory+"Eta2p5to3_Response_Jet1_50to80_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 50to80",10000,0,0.05)
Eta2p5to3JetResolution80to120, Eta2p5to3JetResolutionErr80to120 = CalcResolution(Eta2p5to3Response80to120,outDirectory+"Eta2p5to3_Response_Jet1_80to120_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 80to120",10000,0,0.05)
Eta2p5to3JetResolution120to170, Eta2p5to3JetResolutionErr120to170 = CalcResolution(Eta2p5to3Response120to170,outDirectory+"Eta2p5to3_Response_Jet1_120to170_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 120to170",10000,0,0.05)
Eta2p5to3JetResolution170to300, Eta2p5to3JetResolutionErr170to300 = CalcResolution(Eta2p5to3Response170to300,outDirectory+"Eta2p5to3_Response_Jet1_170to300_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 170to300",10000,0,0.05)
Eta2p5to3JetResolution300to470, Eta2p5to3JetResolutionErr300to470 = CalcResolution(Eta2p5to3Response300to470,outDirectory+"Eta2p5to3_Response_Jet1_300to470_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 300to470",10000,0,0.05)
Eta2p5to3JetResolution470to600, Eta2p5to3JetResolutionErr470to600 = CalcResolution(Eta2p5to3Response470to600,outDirectory+"Eta2p5to3_Response_Jet1_470to600_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 470to600",10000,0,0.05)
Eta2p5to3JetResolution600to800, Eta2p5to3JetResolutionErr600to800 = CalcResolution(Eta2p5to3Response600to800,outDirectory+"Eta2p5to3_Response_Jet1_600to800_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 600to800",10000,0,0.05)
Eta2p5to3JetResolution800to1000, Eta2p5to3JetResolutionErr800to1000 = CalcResolution(Eta2p5to3Response800to1000,outDirectory+"Eta2p5to3_Response_Jet1_800to1000_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 800to1000",10000,0,0.05)
Eta2p5to3JetResolution1000to1400, Eta2p5to3JetResolutionErr1000to1400 = CalcResolution(Eta2p5to3Response1000to1400,outDirectory+"Eta2p5to3_Response_Jet1_1000to1400_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 1000to1400",10000,0,0.05)
Eta2p5to3JetResolution1400to1800, Eta2p5to3JetResolutionErr1400to1800 = CalcResolution(Eta2p5to3Response1400to1800,outDirectory+"Eta2p5to3_Response_Jet1_1400to1800_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 1400to1800",2500000,0,0.1)
Eta2p5to3JetResolution1800to2400, Eta2p5to3JetResolutionErr1800to2400 = CalcResolution(Eta2p5to3Response1800to2400,outDirectory+"Eta2p5to3_Response_Jet1_1800to2400_Run2023.pdf","Events","Eta 2.5 to 3 Response","Eta 2.5 to 3 Response for pt1 1800to2400",140000,0,0.08)
...
with open('/home/jmuecke/code/mueckejonas/BachelorArbeitJM/BachelorStorage/Sim/CSV/Eta2p5to3JetResolutionPt1.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
Eta3to5JetResolution50to80, Eta3to5JetResolutionErr50to80 = CalcResolution(Eta3to5Response50to80,outDirectory+"Eta3to5_Response_Jet1_50to80_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 50to80",10000,0,0.05)
Eta3to5JetResolution80to120, Eta3to5JetResolutionErr80to120 = CalcResolution(Eta3to5Response80to120,outDirectory+"Eta3to5_Response_Jet1_80to120_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 80to120",10000,0,0.05)
Eta3to5JetResolution120to170, Eta3to5JetResolutionErr120to170 = CalcResolution(Eta3to5Response120to170,outDirectory+"Eta3to5_Response_Jet1_120to170_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 120to170",10000,0,0.05)
Eta3to5JetResolution170to300, Eta3to5JetResolutionErr170to300 = CalcResolution(Eta3to5Response170to300,outDirectory+"Eta3to5_Response_Jet1_170to300_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 170to300",10000,0,0.05)
Eta3to5JetResolution300to470, Eta3to5JetResolutionErr300to470 = CalcResolution(Eta3to5Response300to470,outDirectory+"Eta3to5_Response_Jet1_300to470_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 300to470",10000,0,0.05)
Eta3to5JetResolution470to600, Eta3to5JetResolutionErr470to600 = CalcResolution(Eta3to5Response470to600,outDirectory+"Eta3to5_Response_Jet1_470to600_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 470to600",10000,0,0.05)
Eta3to5JetResolution600to800, Eta3to5JetResolutionErr600to800 = CalcResolution(Eta3to5Response600to800,outDirectory+"Eta3to5_Response_Jet1_600to800_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 600to800",10000,0,0.05)
Eta3to5JetResolution800to1000, Eta3to5JetResolutionErr800to1000 = CalcResolution(Eta3to5Response800to1000,outDirectory+"Eta3to5_Response_Jet1_800to1000_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 800to1000",10000,0,0.05)
Eta3to5JetResolution1000to1400, Eta3to5JetResolutionErr1000to1400 = CalcResolution(Eta3to5Response1000to1400,outDirectory+"Eta3to5_Response_Jet1_1000to1400_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 1000to1400",10000,0,0.05)
Eta3to5JetResolution1400to1800, Eta3to5JetResolutionErr1400to1800 = CalcResolution(Eta3to5Response1400to1800,outDirectory+"Eta3to5_Response_Jet1_1400to1800_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 1400to1800",2500000,0,0.1)
Eta3to5JetResolution1800to2400, Eta3to5JetResolutionErr1800to2400 = CalcResolution(Eta3to5Response1800to2400,outDirectory+"Eta3to5_Response_Jet1_1800to2400_Run2023.pdf","Events","Eta 3 to 5 Response","Eta 3 to 5 Response for pt1 1800to2400",140000,0,0.08)
...
with open('/home/jmuecke/code/mueckejonas/BachelorArbeitJM/BachelorStorage/Sim/CSV/Eta3to5JetResolutionPt1.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
outHistFile = ROOT.TFile.Open("/home/jmuecke/code/mueckejonas/BachelorArbeitJM/BachelorStorage/Sim/RootS/FitJetResolutionJet1_DiffEtas.root","RECREATE")
