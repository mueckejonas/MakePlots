...
#Set font size
legend.SetTextSize(0.045)
YDifferencesim_hist.SetMarkerSize(3)
YDifferencesim_hist.SetLineWidth(2)
YDifferencesim_hist.GetYaxis().SetLabelSize(0.045)
YDifferencesim_hist.GetYaxis().SetTitleSize(0.05)
YDifferencesim_hist.GetXaxis().SetLabelSize(0.045)
YDifferencesim_hist.GetXaxis().SetTitleSize(0.05)
#YDifferencesim_hist.GetYaxis().SetLabelOffset(0.01)
#YDifferencesim_hist.GetXaxis().SetLabelOffset(0.01)
canvas.SetBottomMargin(0.15)
canvas.SetTopMargin(0.1)
canvas.SetRightMargin(0.05)
canvas.SetLeftMargin(0.15)
