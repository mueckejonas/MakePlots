...
Eta0to1p3JetResolution = np.array([Eta0to1p3JetResolution3200])
Eta0to1p3JetResolutionErr = np.array([Eta0to1p3JetResolutionErr3200])
PtRanges = np.array([3500])
PtRangesErrh = np.array([300])
PtRangesErrl = np.array([0])
